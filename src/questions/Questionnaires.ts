...
export const askQuestions = async (spinner: Indicators) => {
  ...
  const customTheme: PartialDeep<Theme> = {
    ...
    style: {
      answer: (text: string) => stringBuilder({ text: text, color: colors.answer }),
      message: (text: string) => stringBuilder({ text: text, color: colors.question }),
      error: (text: string) => stringBuilder({ text: `> ${text}`, color: colors.error }),
      defaultAnswer: (text: string) =>
        stringBuilder({ text: text, color: colors.defaultAnswer, modifiers: chalk.bold }),
      help: (text: string) =>
        stringBuilder({ text: text, color: colors.help, modifiers: chalk.dim }),
      highlight: (text: string) => stringBuilder({ text: text, color: colors.highlight }),
      key: (text: string) =>
        stringBuilder({ text: `<${text}>`, color: colors.key, modifiers: chalk.bold })
    }
  };
