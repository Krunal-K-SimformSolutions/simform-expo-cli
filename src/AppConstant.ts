...
const StringConstants = Object.freeze({
  ...
  bundleIdentifierQuestion: `What's your project bundle identifier or package name?\nPackage directory will be created based on this.`,
  ...
  easProjectSlugQuestion: `What's your project Slug?\nBased on this initialize your Expo Application Services.`,
  ...
  apiBaseURLQuestionHelp: `Must use a start with http or https followed by one or more of (A-Z, a-z, 0-9, symbol).`,
  ...
  sentryDsnURLQuestion: `What's your project sentry DSN URL?\nBased on this initialize your crashlytics tool(Sentry).`,
  sentryDsnURLQuestionHelp: `Must use a start with http or https followed by one or more of (A-Z, a-z, 0-9, symbol).`,
  sentryDsnURLDefault: '',
  ...
  sentryOrgSlugQuestion: `What's your project sentry organization slug?\nBased on this initialize your crashlytics tool(Sentry).`,
  ...
  sentryOrgProjectQuestion: `What's your sentry organization project?\nBased on this initialize your crashlytics tool(Sentry).`,
  ...
  sentryAuthTokenQuestion: `What's your project sentry auth token?\nBased on this initialize your crashlytics tool(Sentry).`,
  ...
  setupEnvQuestion: `What's your project environment?\nBased on this initialize your project environment setup.`,
  setupEnvQuestionHelp: `For Example: "development, staging, production"`,
  setupEnvChoices: [
    {
      name: 'Development',
  ...
  repositoryLinkQuestion: `What's your project remote repository URL?\nBased on this initialize your source code management tool(Git)`,
  ...
  msgProjectSetup: 'Initializing project setup',
  msgProjectDirectories: 'Creating project directories',
  msgStaticCodeAnalysis: 'Creating static code analysis configurations',
  msgProjectEnvironmentSetup: 'Creating EAS configurations and Environment variables',
  msgProjectFiles: 'Generate Project Files',
