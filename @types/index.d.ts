declare module 'gradient-string' {
  ...
  import type { StopInput, Instance as TinyGradient } from 'tinygradient';
  ...
  type MultiLineGradientFunction = {
    (str: string): string;
    /**
     * @deprecated
  ...
  export declare function multiline(
    str: string,
