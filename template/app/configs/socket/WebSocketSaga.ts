export const WebSocketSagaTemplate = (): string => {
  return `
    ...
    import {
      CloseEvent,
      type CreateWebSocketAppStateChannelFnReturnType,
      type CreateWebSocketConnectionFnArgsType,
      type CreateWebSocketMessageChannelFnReturnType,
      type CreateWebSocketNetInfoChannelFnReturnType,
      ErrorEvent,
      MessageEvent,
      OpenEvent,
      PingEvent,
      PongEvent,
      RequestEvent,
      type SocketAppStateChannelResponse,
      type SocketMessageChannelResponse,
      type WebSocketConnectActionType,
      type WebSocketEmitActionType,
    ...
    > {
      if (!isEmpty(error?.message)) {
        ...
        //   brightness: toastShowParams?.brightness ?? ToastBrightnessType.medium,
