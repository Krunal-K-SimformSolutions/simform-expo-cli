    ...
    ${
      isReduxThunk
        ? `
            ...
            import { APISuffixURLConst${isReduxSaga ? `, ReduxActionSuffixNameConst` : ''}, StoreActionConst${isAxios ? `, AxiosMethodConst` : ''}${isAWSAmplify ? `, AwsMethodConst` : ''}${isFetch ? `, FetchMethodConst` : ''} } from '../../constants';
          `
        : ''
    }
    import { UserResponse, SignInRequest } from '../../types';
